...
import com.fiap.notification.domain.strategy.EntradaListaEsperaStrategy;
...
class EntradaListaEsperaStrategyTest {

    @InjectMocks
    private EntradaListaEsperaStrategy strategy;

    @Mock
    private NotificadorGateway gateway;

    @Test
    void testEntradaListaEsperaStrategy() {
