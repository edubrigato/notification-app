...
import com.fiap.notification.domain.strategy.ConfirmacaoConsultaStrategy;
...
class ConfirmacaoConsultaStrategyTest {

    @InjectMocks
    private ConfirmacaoConsultaStrategy strategy;

    @Mock
    private NotificadorGateway gateway;

    @Test
    void testConfirmacaoConsultaStrategy() {
