...
public interface NotificacaoRepository extends JpaRepository<NotificacaoEntity, UUID> {
    ...
    NotificacaoEntity findByIdNotificacao(Long idNotificacao);

    List<NotificacaoEntity> findAllByDataNotificacaoIsNull();

    List<NotificacaoEntity> findAllByConfirmadaTrueAndDataConsultaBetween(LocalDateTime inicio, LocalDateTime fim);
